...
<div align="center" style="margin-top:7%"> 
    ...
    <tr>
        <td colspan="2" style="color:white";>Gracias por tu interes en registrarte. Para hacerlo, solo debes llenar
        ...
        <tr>
            ...
            <td>
                <input class="text" type="text" name="tx_nombre" id="tx_nombre" value='<?php echo $str_nombre ?>' size="30"  maxlength="30" />
            </td>
        </tr>
        <tr>
            <td><label for="tx_apPaterno">Apellido paterno</label></td>
            <td>
                <input class="text" type="text" name="tx_apPaterno" id="tx_apPaterno" value='<?php echo $str_apPaterno ?>' size="30"  maxlength="30" />
            </td>
        </tr>
        <tr>
            <td><label for="tx_apMaterno">Apellido materno</label></td>
            <td>
                <input class="text" type="text" name="tx_apMaterno" id="tx_apMaterno"  value='<?php echo $str_apMaterno ?>' size="30"  maxlength="30" />
            </td>
        </tr>
        <tr>
            <td><label for="tx_correo">Correo electronico</label></td>
            <td>
                <input class="text" type="text" name="tx_correo" id="tx_correo"  value='<?php echo $str_correo ?>' size="30"  maxlength="30" />
            </td>
        </tr>
        <tr>
            <td><label for="tx_username">Nombre de usuario</label></td>
            <td>
                <input class="text" type="text" name="tx_username" id="tx_username"  value='<?php echo $str_username ?>' size="25"  maxlength="25"  />
            </td>
        </tr>
        <tr>
            <td><label for="tx_password">Contrase&ntilde;a</label></td>
            <td>
                <input class="text" type="password" name="tx_password" id="tx_password"  value='<?php echo $str_password ?>'  size="25"  maxlength="25" />
            </td>
        </tr>
        <tr>
            <td><label for="tx_password2">Confirme la contrase&ntilde;a</label></td>
            <td>
                <input class="text" type="password" name="tx_password2" id="tx_password2"  value='<?php echo $str_password2 ?>'  size="25"  maxlength="25" />
            </td>
        </tr>
        <tr>
            ...
            <td style="color:white">
                ...
                <input type="radio" name="rad_TipoUsuario" id="rad_TipoUsuario" value="2" checked="checked"  /> Normal &nbsp;&nbsp;&nbsp;
    ...
    <tr>
        ...
        <td align="center" colspan="2">
            <br /><br />
            <input class="button" type="button" onClick="javascript: location.href='principal.php'" name="cancelar" value="Cancelar" >
            &nbsp;&nbsp;&nbsp;&nbsp;
            <input class="button" type="submit" name="registrarme" value="Registrar" >
        </td>
    </tr>
